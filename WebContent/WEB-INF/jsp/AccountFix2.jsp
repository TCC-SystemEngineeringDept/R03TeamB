                ...
                <tbody>
                    <tr>
                     <%	for (String[] s : list) { %> 
                        ...
                        <td>
                            <input type="text" size="50" name="name" value=<%= s[0] %>><!--アカウント名を入力するテキストボックス-->
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                            <input type="text" size="50" email="email" name="email" value=<%= s[1] %>><!--メールアドレスを入力するテキストボックス-->
                        </td>
                    ...
                    <h3 style="text-align: center;">  
                        <button type="submit" formaction="AccountFix4" class="btn btn--blue btn-outline-primary">修正する<!-- アカウント追加画面へ遷移させる--></button>
                        <button type="submit" formaction="AccountFix3" class="btn btn--red btn-outline-danger" id="Fix">削除する</button><!-- アカウントを削除する-->
                    </h3>
